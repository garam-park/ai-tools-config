...
<!-- 머지하려는 PR이 해결/완료하는 작업 카드 번호 명시.
     tasks/002.done/total/NN-*.md 에 있는 카드면 링크. -->

- 카드: `tasks/002.done/total/NN-*.md`
- 묶음 작업인 경우 모두 나열
...
<!-- 카드 이동은 운영자가 수행하지만, PR 본문에서 해당 카드 이동 여부 명시. -->

- [ ] `tasks/001.todo/total/NN-*.md` → `tasks/002.done/total/NN-*.md` 이동 완료
- [ ] `tasks/STATUS.md` 갱신
